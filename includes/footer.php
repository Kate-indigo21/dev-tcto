...
<div class="bg-msu-deep-ocean text-white-pure">
    <div class="mb-[60px] xl:mt-[80px] xs:mt-[40px]">
        ...
        <img src="<?php echo $base_url; ?>images/rectangle.png" alt=""
        ...
        <div
            ...
            <div class="flex xl:mt-0 xs:mt-10 xl:ml-[70px] xs:ml-0 xl:gap-[25px]">
                ...
                <ul class="xl:ml-[70px] xs:ml-[52px] xl:min-w-[170px]">
                    ...
                    <li>
                        <a href="/admissions#shifting" class="paragraph p2 text-titanium mb-1">Returning / Shifting
                        </a>
                    </li>
                    <li>
                        <a href="/admissions#remedial" class="paragraph p2 text-titanium mb-1">Remedial Program
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/admissions#scholarship" class="paragraph p2 text-titanium mb-1">Scholarships & Grants
                        </a>
                    </li>
                </ul>
            </div>
            <div class="flex xl:mt-0 xs:mt-10 xl:ml-[70px] xs:ml-0 xl:gap-[25px]">
                ...
                <ul class="xl:ml-[70px] xs:ml-[52px] xl:min-w-[170px]">
                    ...
                    <li>
                        <a href="/offices#administrative" class="paragraph p2 text-titanium mb-1">Administrative</a>
                    </li>
                    <li>
            ...
            <div class="xl:mt-0 xs:mt-10 xl:ml-[70px] xs:ml-0 xl:gap-[25px] xl:min-w-[170px]">
                ...
                <div class="flex xl:flex-col xs:flex-row xl:items-start xs:items-center xl:gap-0 xs:gap-[137px]">
...
<div class="bg-msu-deep-ocean text-white-pure justify-center xl:px-[12.5%] xs:px-[3.85%] xl:pt-20 xs:pt-10">
    <div class="flex flex-col justify-center items-center text-center">
        <img src="<?php echo $base_url; ?>images/MSU%20Seal%20New%20%28Official%29.png" alt=""
    ...
    <div id="govlogo" class="flex xl:gap-5 xs:gap-3 xl:mt-20 xs:mt-9 xl:mb-[70px] xs:mb-[80px] justify-center">
        <img src="<?php echo $base_url; ?>images/Republika%20ng%20pilipinas.png" alt=""
            class="xl:h-[100px] xs:h-[75px]" />
        <a href="transparency-seal.html"><img src="<?php echo $base_url; ?>images/transparency_seal.png" alt=""
                class="xl:h-[100px] xs:h-[75px]" /></a>
        <a href="https://www.foi.gov.ph/" target="_blank"><img src="<?php echo $base_url; ?>images/FOI-logo.png" alt=""
                class="xl:h-[100px] xs:h-[75px]" /></a>
    ...
    <div class="flex xl:flex-row xs:flex-col justify-center xl:text-left xs:text-center xl:items-start xs:items-center">
        <div class="flex flex-col max-w-[300px] xl:mr-[174px] xs:mr-0 xl:gap-[30px] xs:gap-[30px] xs:mb-[50px]">
            <div class="xs:mb-10">
    ...
    <div class="flex gap-[33.33px] mt-8 justify-center">
        ...
        <a href="https://web.facebook.com/msutcto"><img src="<?php echo $base_url; ?>images/social%20media/facebook.png"
                alt="" /></a>
...
<div include-html="https://insights.elishatelecom.com/aichat/embedded-chatbot?key=guXJzVN2UnYvtbBf70C3GKEpDF5wZ9ad"
    id="chatbot"></div>
</body>
